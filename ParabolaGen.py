...
def generate_parabola(x_dim, y_dim, time_dimension, num_of_files, origin):
    # create tensor
    data = torch.zeros(num_of_files, y_dim, x_dim)

    for i in range (0,num_of_files):
        data[i, :, :] = create_track(data[i, :, :], origin, time_dimension)
...
# data = generate_parabola(x_dim, y_dim, time_dimension, num_of_files, origin)
